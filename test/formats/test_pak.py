...
def _compressed_resource():
    return {
        ...
        'contents': {
            ...
            'offset1': 13152, 'offset2': 13664, 'length': 512
        },
        'size': 512,
    }
...
def test_compare_from_build():
    ...
    source = {
        'named_resources': [
            {"asset": {"type": u'TXTR', "id": 201335801}, "name": u'TXTR_ElevatorIcon_1'},
            {"asset": {"type": u'TXTR', "id": 239414538}, "name": u'TXTR_ElevatorIcon'},
            {"asset": {"type": u'TXTR', "id": 564256465}, "name": u'TXTR_QuaterCurve'},
            {"asset": {"type": u'TXTR', "id": 568030977}, "name": u'TXTR_SaveStationIcon_1'},
        ],
        'resources': [
            {'asset': {'id': 201335801, 'type': 'TXTR'},
             'compressed': 1,
             'contents': {
                 'value': b'\x00\x00\x00\x00\x00@\x00@\x00\x00\x00\x05\x00\x00\x00\x00\n\xaa\xaa\xaa\n\xcc\xcc\xcc\n\xcc\xcc\xcc\n\xcc\xcc\xcc\n\xcc\xcc\xcc\n\xcc\xcc\xaa\n\xcc\xcc\xa0'
            ...
            {'asset': {'id': 239414538, 'type': 'TXTR'},
             'compressed': 1,
             'contents': {
                 'value': b'\x00\x00\x00\x02\x00 \x00 \x00\x00\x00\x04\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\x0f\xff'
            ...
            {'asset': {'id': 564256465, 'type': 'TXTR'},
             'compressed': 1,
             'contents': {
                 'value': b'\x00\x00\x00\x00\x00 \x00 \x00\x00\x00\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
                          b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
                          b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    ...
    for resource in decoded["resources"]:
        sizes.append(resource["contents"]["length"])
        resource["contents"] = {"value": resource["contents"]["value"]}
