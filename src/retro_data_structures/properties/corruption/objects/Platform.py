...
class Platform(BaseObjectType):
    ...
    unknown_0x6b5e87a7: float = dataclasses.field(
        default=1800.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x6B5E87A7, original_name="Unknown"),
        },
    )
    look_at_velocity: float = dataclasses.field(
        default=30.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x3DC75733, original_name="LookAtVelocity"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_0x6b5e87a7 = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x3DC75733
        look_at_velocity = structs.BIG_f.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0x6b5e87a7))

        data.write(b"=\xc7W3")  # 0x3dc75733
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.look_at_velocity))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x6B5E87A7: ("unknown_0x6b5e87a7", structs.decode_BIG_f),
    0x3DC75733: ("look_at_velocity", structs.decode_BIG_f),
}
