...
class DefenseMechanoid(BaseObjectType):
    ...
    defense_mechanoid_data_0x5231ed05: DefenseMechanoidData = dataclasses.field(
        default_factory=DefenseMechanoidData,
        metadata={
            "reflection": FieldReflection[DefenseMechanoidData](
                DefenseMechanoidData,
                id=0x5231ED05,
                original_name="DefenseMechanoidData",
                from_json=DefenseMechanoidData.from_json,
                to_json=DefenseMechanoidData.to_json,
            ),
        },
    )
    ...
    defense_mechanoid_data_0x8e34b059: DefenseMechanoidData = dataclasses.field(
        default_factory=DefenseMechanoidData,
        metadata={
            "reflection": FieldReflection[DefenseMechanoidData](
                DefenseMechanoidData,
    ...
    defense_mechanoid_data_0x838ee838: DefenseMechanoidData = dataclasses.field(
        default_factory=DefenseMechanoidData,
        metadata={
            "reflection": FieldReflection[DefenseMechanoidData](
                DefenseMechanoidData,
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        defense_mechanoid_data_0x5231ed05 = DefenseMechanoidData.from_stream(data, game, property_size)
        ...
        defense_mechanoid_data_0x8e34b059 = DefenseMechanoidData.from_stream(data, game, property_size)
        ...
        defense_mechanoid_data_0x838ee838 = DefenseMechanoidData.from_stream(data, game, property_size)
        ...
        return cls(
            editor_properties,
            unknown_struct26,
            defense_mechanoid_data_0x5231ed05,
            patterned,
            defense_mechanoid_data_0x8e34b059,
            patterned_ai_0x1464ae05,
            defense_mechanoid_data_0x838ee838,
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.defense_mechanoid_data_0x5231ed05.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.defense_mechanoid_data_0x8e34b059.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.defense_mechanoid_data_0x838ee838.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            defense_mechanoid_data_0x5231ed05=DefenseMechanoidData.from_json(
                json_data["defense_mechanoid_data_0x5231ed05"]
            ),
            patterned=PatternedAITypedef.from_json(json_data["patterned"]),
            defense_mechanoid_data_0x8e34b059=DefenseMechanoidData.from_json(
                json_data["defense_mechanoid_data_0x8e34b059"]
            ),
            patterned_ai_0x1464ae05=PatternedAITypedef.from_json(json_data["patterned_ai_0x1464ae05"]),
            defense_mechanoid_data_0x838ee838=DefenseMechanoidData.from_json(
                json_data["defense_mechanoid_data_0x838ee838"]
            ),
...
def _decode_defense_mechanoid_data_0x5231ed05(
    data: typing.BinaryIO, game: Game, property_size: int
) -> DefenseMechanoidData:
    return DefenseMechanoidData.from_stream(data, game, property_size)
...
def _decode_defense_mechanoid_data_0x8e34b059(
    data: typing.BinaryIO, game: Game, property_size: int
) -> DefenseMechanoidData:
    return DefenseMechanoidData.from_stream(data, game, property_size)
...
def _decode_defense_mechanoid_data_0x838ee838(
    data: typing.BinaryIO, game: Game, property_size: int
) -> DefenseMechanoidData:
    return DefenseMechanoidData.from_stream(data, game, property_size)
