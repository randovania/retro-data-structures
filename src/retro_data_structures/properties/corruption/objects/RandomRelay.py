...
class RandomRelay(BaseObjectType):
    ...
    choose_inactive: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x432E9D73, original_name="ChooseInactive"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        choose_inactive = structs.BIG_bool_.unpack(data.read(1))[0]

        return cls(editor_properties, count, random_adjust, percent_count, is_random_chance, choose_inactive)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.choose_inactive))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x432E9D73: ("choose_inactive", structs.decode_BIG_bool_),
}
