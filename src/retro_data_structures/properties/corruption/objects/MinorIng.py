...
class MinorIng(BaseObjectType):
    ...
    unknown_struct45: UnknownStruct45 = dataclasses.field(
        default_factory=UnknownStruct45,
        metadata={
            "reflection": FieldReflection[UnknownStruct45](
                UnknownStruct45,
                id=0xA3A2AC3F,
                original_name="UnknownStruct45",
                from_json=UnknownStruct45.from_json,
                to_json=UnknownStruct45.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_struct45 = UnknownStruct45.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.unknown_struct45.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
...
def _decode_unknown_struct45(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct45:
    return UnknownStruct45.from_stream(data, game, property_size)
