...
if typing.TYPE_CHECKING:
    ...
    class SeedBoss2BotSwarmJson(typing_extensions.TypedDict):
...
class SeedBoss2BotSwarm(BaseObjectType):
    ...
    unknown_struct59: UnknownStruct59 = dataclasses.field(
        default_factory=UnknownStruct59,
        metadata={
            "reflection": FieldReflection[UnknownStruct59](
                UnknownStruct59,
                id=0xD6CC62CB,
                original_name="UnknownStruct59",
                from_json=UnknownStruct59.from_json,
                to_json=UnknownStruct59.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_struct59 = UnknownStruct59.from_stream(data, game, property_size)

        return cls(editor_properties, patterned, actor_information, unknown_struct59)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.unknown_struct59.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SeedBoss2BotSwarmJson", data)
        return cls(
...
def _decode_unknown_struct59(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct59:
    return UnknownStruct59.from_stream(data, game, property_size)
