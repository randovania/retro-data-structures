...
class PillBug(BaseObjectType):
    ...
    unknown_struct52: UnknownStruct52 = dataclasses.field(
        default_factory=UnknownStruct52,
        metadata={
            "reflection": FieldReflection[UnknownStruct52](
                UnknownStruct52,
                id=0x0EBE6DCB,
                original_name="UnknownStruct52",
                from_json=UnknownStruct52.from_json,
                to_json=UnknownStruct52.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_struct52 = UnknownStruct52.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.unknown_struct52.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
...
def _decode_unknown_struct52(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct52:
    return UnknownStruct52.from_stream(data, game, property_size)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x0EBE6DCB: ("unknown_struct52", _decode_unknown_struct52),
}
