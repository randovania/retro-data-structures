...
class SteamDrone(BaseObjectType):
    ...
    unknown_struct61: UnknownStruct61 = dataclasses.field(
        default_factory=UnknownStruct61,
        metadata={
            "reflection": FieldReflection[UnknownStruct61](
                UnknownStruct61,
                id=0xA23F161C,
                original_name="UnknownStruct61",
                from_json=UnknownStruct61.from_json,
                to_json=UnknownStruct61.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_struct61 = UnknownStruct61.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.unknown_struct61.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
...
def _decode_unknown_struct61(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct61:
    return UnknownStruct61.from_stream(data, game, property_size)
