...
if typing.TYPE_CHECKING:
    ...
    class AudioOccluderJson(typing_extensions.TypedDict):
...
class AudioOccluder(BaseObjectType):
    ...
    unknown: int = dataclasses.field(
        default=32000,
        metadata={
            "reflection": FieldReflection[int](int, id=0xFA7B5650, original_name="Unknown"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, volume_attenuation, unknown)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("AudioOccluderJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xFA7B5650: ("unknown", structs.decode_BIG_l),
}
