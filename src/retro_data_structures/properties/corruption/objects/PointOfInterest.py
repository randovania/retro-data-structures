...
class PointOfInterest(BaseObjectType):
    ...
    scan_offset: Vector = dataclasses.field(
    ...
    scan_offset_local: bool = dataclasses.field(
        default=True,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x91351B69, original_name="ScanOffsetLocal"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        scan_offset = Vector.from_stream(data, game, property_size)
        ...
        scan_offset_local = structs.BIG_bool_.unpack(data.read(1))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        self.scan_offset.to_stream(data, game)
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.scan_offset_local))
...
def _decode_scan_offset(data: typing.BinaryIO, game: Game, property_size: int) -> Vector:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x91351B69: ("scan_offset_local", structs.decode_BIG_bool_),
}
