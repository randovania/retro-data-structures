...
class TeamAI(BaseObjectType):
    ...
    max_special_attackers: int = dataclasses.field(
        default=0,
        metadata={
            "reflection": FieldReflection[int](int, id=0x1C3A365C, original_name="MaxSpecialAttackers"),
        },
    )
    ...
    unknown_0x69cde528: int = dataclasses.field(
        default=1,
        metadata={
            "reflection": FieldReflection[int](int, id=0x69CDE528, original_name="Unknown"),
        },
    )
    ...
    unknown_0x9856e6f0: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x9856E6F0, original_name="Unknown"),
        },
    )
    max_hypermode_members: int = dataclasses.field(
        default=1,
        metadata={
            "reflection": FieldReflection[int](int, id=0x46B94E2C, original_name="MaxHypermodeMembers"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        max_special_attackers = structs.BIG_l.unpack(data.read(4))[0]
        ...
        unknown_0x69cde528 = structs.BIG_l.unpack(data.read(4))[0]
        ...
        unknown_0x9856e6f0 = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x46B94E2C
        max_hypermode_members = structs.BIG_l.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_l.pack(self.max_special_attackers))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_l.pack(self.unknown_0x69cde528))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0x9856e6f0))

        data.write(b"F\xb9N,")  # 0x46b94e2c
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_l.pack(self.max_hypermode_members))
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            max_special_attackers=json_data["max_special_attackers"],
            ...
            unknown_0x69cde528=json_data["unknown_0x69cde528"],
            ...
            unknown_0x9856e6f0=json_data["unknown_0x9856e6f0"],
            max_hypermode_members=json_data["max_hypermode_members"],
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x1C3A365C: ("max_special_attackers", structs.decode_BIG_l),
    ...
    0x69CDE528: ("unknown_0x69cde528", structs.decode_BIG_l),
    ...
    0x9856E6F0: ("unknown_0x9856e6f0", structs.decode_BIG_f),
    0x46B94E2C: ("max_hypermode_members", structs.decode_BIG_l),
}
