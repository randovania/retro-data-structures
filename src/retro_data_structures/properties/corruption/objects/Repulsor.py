...
class Repulsor(BaseObjectType):
    ...
    shape: int = dataclasses.field(
        default=0,
        metadata={
            "reflection": FieldReflection[int](int, id=0xF9BB2DB6, original_name="Shape"),
        },
    )
    ...
    value: float = dataclasses.field(
        default=-1.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x8DCD8978, original_name="Value"),
        },
    )
    flags_repulsor: int = dataclasses.field(
        default=0,
        metadata={
            "reflection": FieldReflection[int](int, id=0x8AEF6BD2, original_name="FlagsRepulsor"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        shape = structs.BIG_l.unpack(data.read(4))[0]
        ...
        flags_repulsor = structs.BIG_l.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_l.pack(self.shape))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_l.pack(self.flags_repulsor))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xF9BB2DB6: ("shape", structs.decode_BIG_l),
    0x78C507EB: ("radius", structs.decode_BIG_f),
    0x8DCD8978: ("value", structs.decode_BIG_f),
    0x8AEF6BD2: ("flags_repulsor", structs.decode_BIG_l),
}
