...
class Pickup(BaseObjectType):
    ...
    unknown_0x2de4a294: bool = dataclasses.field(
        default=False,
        metadata={
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        pickup_effect = structs.BIG_Q.unpack(data.read(8))[0]
        ...
        unknown_0x2de4a294 = structs.BIG_bool_.unpack(data.read(1))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x08")  # size
        data.write(structs.BIG_Q.pack(self.pickup_effect))
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0x2de4a294))
