...
if typing.TYPE_CHECKING:
    ...
    class AreaVisitMapControllerJson(typing_extensions.TypedDict):
...
class AreaVisitMapController(BaseObjectType):
    ...
    area: int = dataclasses.field(
        default=2,
        metadata={
            "reflection": FieldReflection[int](int, id=0xFF5D997E, original_name="Area"),
        },
    )
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("AreaVisitMapControllerJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xFF5D997E: ("area", structs.decode_BIG_l),
}
