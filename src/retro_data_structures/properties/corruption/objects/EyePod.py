...
if typing.TYPE_CHECKING:
    ...
    class EyePodJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        wall_crawler_properties: json_util.JsonObject
        eye_pod_properties: json_util.JsonObject
...
class EyePod(BaseObjectType):
    ...
    eye_pod_properties: EyePodData = dataclasses.field(
        default_factory=EyePodData,
        metadata={
            "reflection": FieldReflection[EyePodData](
                EyePodData,
                id=0x9214A518,
                original_name="EyePodProperties",
                from_json=EyePodData.from_json,
                to_json=EyePodData.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        eye_pod_properties = EyePodData.from_stream(data, game, property_size)

        return cls(editor_properties, actor_information, patterned, wall_crawler_properties, eye_pod_properties)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.eye_pod_properties.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("EyePodJson", data)
        return cls(
            ...
            eye_pod_properties=EyePodData.from_json(json_data["eye_pod_properties"]),
        )
...
def _decode_eye_pod_properties(data: typing.BinaryIO, game: Game, property_size: int) -> EyePodData:
    return EyePodData.from_stream(data, game, property_size)
