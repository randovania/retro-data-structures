...
if typing.TYPE_CHECKING:
    ...
    class FlyingPirateJson(typing_extensions.TypedDict):
        ...
        flying_pirate_properties: json_util.JsonObject
...
class FlyingPirate(BaseObjectType):
    ...
    flying_pirate_properties: FlyingPirateData = dataclasses.field(
        default_factory=FlyingPirateData,
        metadata={
            "reflection": FieldReflection[FlyingPirateData](
                FlyingPirateData,
                id=0xB327E803,
                original_name="FlyingPirateProperties",
                from_json=FlyingPirateData.from_json,
                to_json=FlyingPirateData.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        flying_pirate_properties = FlyingPirateData.from_stream(data, game, property_size)

        return cls(editor_properties, patterned, actor_information, flying_pirate_properties)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.flying_pirate_properties.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            flying_pirate_properties=FlyingPirateData.from_json(json_data["flying_pirate_properties"]),
        )
...
def _decode_flying_pirate_properties(data: typing.BinaryIO, game: Game, property_size: int) -> FlyingPirateData:
    return FlyingPirateData.from_stream(data, game, property_size)
