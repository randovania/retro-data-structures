...
class FishCloud(BaseObjectType):
    ...
    fish_count: int = dataclasses.field(
        default=20,
        metadata={
            "reflection": FieldReflection[int](int, id=0x2264062E, original_name="FishCount"),
        },
    )
    fish_scale: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x97BEFF4F, original_name="FishScale"),
        },
    )
    ...
    maximum_turn_angle: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0xCBAB54C1, original_name="MaximumTurnAngle"),
        },
    )
    ...
    unknown_0x9939d085: int = dataclasses.field(
        default=3257279650,
        metadata={
            "reflection": FieldReflection[int](int, id=0x9939D085, original_name="Unknown"),
        },
    )  # Choice
    ...
    respawn_wait_time: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0xFE44B7A4, original_name="RespawnWaitTime"),
        },
    )
    respawn_fade_time: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x942D6F2A, original_name="RespawnFadeTime"),
        },
    )
    ...
    death_effect0_scale: float = dataclasses.field(
        default=1.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x23D57BB1, original_name="DeathEffect0Scale"),
        },
    )
    ...
    death_effect1_scale: float = dataclasses.field(
        default=1.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0xE25BA471, original_name="DeathEffect1Scale"),
        },
    )
    ...
    death_effect2_scale: float = dataclasses.field(
        default=1.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x7BB9C270, original_name="DeathEffect2Scale"),
        },
    )
    ...
    death_effect3_scale: float = dataclasses.field(
        default=1.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0xBA371DB0, original_name="DeathEffect3Scale"),
        },
    )
    ...
    looped_sound: AssetId = dataclasses.field(
        default=default_asset_id,
        metadata={
            "asset_types": ["CAUD"],
            "reflection": FieldReflection[AssetId](AssetId, id=0x05C79560, original_name="LoopedSound"),
        },
    )
    unknown_0xd7bce5da: float = dataclasses.field(
        default=20.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0xD7BCE5DA, original_name="Unknown"),
        },
    )
    unknown_0xe8b7e32e: float = dataclasses.field(
        default=25.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0xE8B7E32E, original_name="Unknown"),
        },
    )
    ...
    aggression_data: FishCloudAggressionData = dataclasses.field(
        default_factory=FishCloudAggressionData,
        metadata={
            "reflection": FieldReflection[FishCloudAggressionData](
                FishCloudAggressionData,
                id=0x0D9C6715,
                original_name="AggressionData",
                from_json=FishCloudAggressionData.from_json,
                to_json=FishCloudAggressionData.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        fish_model = structs.BIG_Q.unpack(data.read(8))[0]
        ...
        fish_count = structs.BIG_l.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x97BEFF4F
        fish_scale = structs.BIG_f.unpack(data.read(4))[0]
        ...
        maximum_turn_angle = structs.BIG_f.unpack(data.read(4))[0]
        ...
        unknown_0x9939d085 = structs.BIG_L.unpack(data.read(4))[0]
        ...
        respawn_wait_time = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x942D6F2A
        respawn_fade_time = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x5BA86245
        death_effect0 = structs.BIG_Q.unpack(data.read(8))[0]
        ...
        death_effect0_scale = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x90F4B1E0
        death_effect1 = structs.BIG_Q.unpack(data.read(8))[0]
        ...
        death_effect1_scale = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x1660C34E
        death_effect2 = structs.BIG_Q.unpack(data.read(8))[0]
        ...
        death_effect2_scale = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0xDD3C10EB
        death_effect3 = structs.BIG_Q.unpack(data.read(8))[0]
        ...
        death_effect3_scale = structs.BIG_f.unpack(data.read(4))[0]
        ...
        looped_sound = structs.BIG_Q.unpack(data.read(8))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0xD7BCE5DA
        unknown_0xd7bce5da = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0xE8B7E32E
        unknown_0xe8b7e32e = structs.BIG_f.unpack(data.read(4))[0]
        ...
        aggression_data = FishCloudAggressionData.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_Q.pack(self.fish_model))
        ...
        data.write(structs.BIG_l.pack(self.fish_count))

        data.write(b"\x97\xbe\xffO")  # 0x97beff4f
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.fish_scale))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.maximum_turn_angle))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_L.pack(self.unknown_0x9939d085))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.respawn_wait_time))

        data.write(b"\x94-o*")  # 0x942d6f2a
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.respawn_fade_time))

        data.write(b"[\xa8bE")  # 0x5ba86245
        data.write(b"\x00\x08")  # size
        data.write(structs.BIG_Q.pack(self.death_effect0))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.death_effect0_scale))

        data.write(b"\x90\xf4\xb1\xe0")  # 0x90f4b1e0
        data.write(b"\x00\x08")  # size
        data.write(structs.BIG_Q.pack(self.death_effect1))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.death_effect1_scale))

        data.write(b"\x16`\xc3N")  # 0x1660c34e
        data.write(b"\x00\x08")  # size
        data.write(structs.BIG_Q.pack(self.death_effect2))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.death_effect2_scale))

        data.write(b"\xdd<\x10\xeb")  # 0xdd3c10eb
        data.write(b"\x00\x08")  # size
        data.write(structs.BIG_Q.pack(self.death_effect3))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.death_effect3_scale))
        ...
        data.write(b"\x00\x08")  # size
        data.write(structs.BIG_Q.pack(self.looped_sound))

        data.write(b"\xd7\xbc\xe5\xda")  # 0xd7bce5da
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0xd7bce5da))

        data.write(b"\xe8\xb7\xe3.")  # 0xe8b7e32e
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0xe8b7e32e))
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.aggression_data.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
...
def _decode_aggression_data(data: typing.BinaryIO, game: Game, property_size: int) -> FishCloudAggressionData:
    return FishCloudAggressionData.from_stream(data, game, property_size)


_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    0x255A4580: ("editor_properties", _decode_editor_properties),
    0x7990A3B6: ("fish_model", structs.decode_BIG_Q),
    0xA244C9D8: ("character_animation_information", _decode_character_animation_information),
    0x2264062E: ("fish_count", structs.decode_BIG_l),
    0x97BEFF4F: ("fish_scale", structs.decode_BIG_f),
    0x6392404E: ("speed", structs.decode_BIG_f),
    0xCBAB54C1: ("maximum_turn_angle", structs.decode_BIG_f),
    ...
    0x9939D085: ("unknown_0x9939d085", structs.decode_BIG_L),
    ...
    0xFE44B7A4: ("respawn_wait_time", structs.decode_BIG_f),
    0x942D6F2A: ("respawn_fade_time", structs.decode_BIG_f),
    0x5BA86245: ("death_effect0", structs.decode_BIG_Q),
    0xA8232FB1: ("death_effect0_count", structs.decode_BIG_l),
    0x23D57BB1: ("death_effect0_scale", structs.decode_BIG_f),
    0x90F4B1E0: ("death_effect1", structs.decode_BIG_Q),
    0xBF583BF2: ("death_effect1_count", structs.decode_BIG_l),
    0xE25BA471: ("death_effect1_scale", structs.decode_BIG_f),
    0x1660C34E: ("death_effect2", structs.decode_BIG_Q),
    0x86D50737: ("death_effect2_count", structs.decode_BIG_l),
    0x7BB9C270: ("death_effect2_scale", structs.decode_BIG_f),
    0xDD3C10EB: ("death_effect3", structs.decode_BIG_Q),
    0x91AE1374: ("death_effect3_count", structs.decode_BIG_l),
    0xBA371DB0: ("death_effect3_scale", structs.decode_BIG_f),
    0xC7C3F610: ("death_sound", structs.decode_BIG_Q),
    0x05C79560: ("looped_sound", structs.decode_BIG_Q),
    0xD7BCE5DA: ("unknown_0xd7bce5da", structs.decode_BIG_f),
    0xE8B7E32E: ("unknown_0xe8b7e32e", structs.decode_BIG_f),
    0xC320A050: ("unknown_0xc320a050", structs.decode_BIG_bool_),
    0xCD4C81A1: ("unknown_0xcd4c81a1", structs.decode_BIG_bool_),
    0x0D9C6715: ("aggression_data", _decode_aggression_data),
}
