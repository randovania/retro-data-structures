...
if typing.TYPE_CHECKING:
    ...
    class PhazonPufferJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        patterned: json_util.JsonObject
        actor_information: json_util.JsonObject
        unknown_struct51: json_util.JsonObject
...
class PhazonPuffer(BaseObjectType):
    ...
    unknown_struct51: UnknownStruct51 = dataclasses.field(
        default_factory=UnknownStruct51,
        metadata={
            "reflection": FieldReflection[UnknownStruct51](
                UnknownStruct51,
                id=0x1BE8B2DB,
                original_name="UnknownStruct51",
                from_json=UnknownStruct51.from_json,
                to_json=UnknownStruct51.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_struct51 = UnknownStruct51.from_stream(data, game, property_size)

        return cls(editor_properties, patterned, actor_information, unknown_struct51)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.unknown_struct51.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("PhazonPufferJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data["editor_properties"]),
            patterned=PatternedAITypedef.from_json(json_data["patterned"]),
            actor_information=ActorParameters.from_json(json_data["actor_information"]),
            unknown_struct51=UnknownStruct51.from_json(json_data["unknown_struct51"]),
        )
...
def _decode_unknown_struct51(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct51:
    return UnknownStruct51.from_stream(data, game, property_size)
