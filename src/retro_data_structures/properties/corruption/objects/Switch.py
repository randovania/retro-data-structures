...
class Switch(BaseObjectType):
    ...
    is_auto_close: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x054A1E34, original_name="IsAutoClose"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        is_auto_close = structs.BIG_bool_.unpack(data.read(1))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.is_auto_close))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x054A1E34: ("is_auto_close", structs.decode_BIG_bool_),
}
