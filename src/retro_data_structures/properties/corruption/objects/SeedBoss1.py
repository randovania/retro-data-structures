...
if typing.TYPE_CHECKING:
    ...
    class SeedBoss1Json(typing_extensions.TypedDict):
...
class SeedBoss1(BaseObjectType):
    ...
    data: SeedBoss1Data = dataclasses.field(
        default_factory=SeedBoss1Data,
        metadata={
            "reflection": FieldReflection[SeedBoss1Data](
                SeedBoss1Data,
                id=0xF6E66110,
                original_name="Data",
                from_json=SeedBoss1Data.from_json,
                to_json=SeedBoss1Data.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        data_ = SeedBoss1Data.from_stream(data, game, property_size)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SeedBoss1Json", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data["editor_properties"]),
            patterned=PatternedAITypedef.from_json(json_data["patterned"]),
            actor_information=ActorParameters.from_json(json_data["actor_information"]),
            data=SeedBoss1Data.from_json(json_data["data"]),
        )
...
def _decode_data(data: typing.BinaryIO, game: Game, property_size: int) -> SeedBoss1Data:
    return SeedBoss1Data.from_stream(data, game, property_size)
