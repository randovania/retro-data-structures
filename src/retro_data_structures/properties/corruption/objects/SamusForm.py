...
class SamusForm(BaseObjectType):
    ...
    unknown_struct57: UnknownStruct57 = dataclasses.field(
        default_factory=UnknownStruct57,
        metadata={
            "reflection": FieldReflection[UnknownStruct57](
                UnknownStruct57,
                id=0x7EFC051A,
                original_name="UnknownStruct57",
                from_json=UnknownStruct57.from_json,
                to_json=UnknownStruct57.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_struct57 = UnknownStruct57.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.unknown_struct57.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
...
def _decode_unknown_struct57(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct57:
    return UnknownStruct57.from_stream(data, game, property_size)
