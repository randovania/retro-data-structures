...
class DarkSamus(BaseObjectType):
    ...
    unknown_struct27: UnknownStruct27 = dataclasses.field(
        default_factory=UnknownStruct27,
        metadata={
            "reflection": FieldReflection[UnknownStruct27](
                UnknownStruct27,
                id=0x0214A7EB,
                original_name="UnknownStruct27",
                from_json=UnknownStruct27.from_json,
                to_json=UnknownStruct27.to_json,
            ),
        },
    )
    dark_samus_properties: DarkSamusData = dataclasses.field(
        default_factory=DarkSamusData,
        metadata={
            "reflection": FieldReflection[DarkSamusData](
                DarkSamusData,
                id=0x02C43C41,
                original_name="DarkSamusProperties",
                from_json=DarkSamusData.from_json,
                to_json=DarkSamusData.to_json,
            ),
        },
    )
    ...
    dark_samus_data: DarkSamusData = dataclasses.field(
        default_factory=DarkSamusData,
        metadata={
            "reflection": FieldReflection[DarkSamusData](
                DarkSamusData,
                id=0xDD042FE0,
                original_name="DarkSamusData",
                from_json=DarkSamusData.from_json,
                to_json=DarkSamusData.to_json,
            ),
        },
    ...
    dark_samus_properties_elite_difficulty: DarkSamusData = dataclasses.field(
        default_factory=DarkSamusData,
        metadata={
            "reflection": FieldReflection[DarkSamusData](
                DarkSamusData,
                id=0xD0621C92,
                original_name="DarkSamusPropertiesEliteDifficulty",
                from_json=DarkSamusData.from_json,
                to_json=DarkSamusData.to_json,
            ),
        },
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_struct27 = UnknownStruct27.from_stream(data, game, property_size)

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x02C43C41
        dark_samus_properties = DarkSamusData.from_stream(data, game, property_size)
        ...
        dark_samus_data = DarkSamusData.from_stream(data, game, property_size)
        ...
        dark_samus_properties_elite_difficulty = DarkSamusData.from_stream(data, game, property_size)
        ...
        return cls(
            editor_properties,
            unknown_struct27,
            dark_samus_properties,
            patterned,
            dark_samus_data,
            patterned_ai_0x1464ae05,
            dark_samus_properties_elite_difficulty,
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.unknown_struct27.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.dark_samus_properties.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.dark_samus_data.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.dark_samus_properties_elite_difficulty.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            dark_samus_properties_elite_difficulty=DarkSamusData.from_json(
                json_data["dark_samus_properties_elite_difficulty"]
            ),
...
def _decode_unknown_struct27(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct27:
    return UnknownStruct27.from_stream(data, game, property_size)


def _decode_dark_samus_properties(data: typing.BinaryIO, game: Game, property_size: int) -> DarkSamusData:
    return DarkSamusData.from_stream(data, game, property_size)
...
def _decode_dark_samus_data(data: typing.BinaryIO, game: Game, property_size: int) -> DarkSamusData:
    return DarkSamusData.from_stream(data, game, property_size)
...
def _decode_dark_samus_properties_elite_difficulty(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x0214A7EB: ("unknown_struct27", _decode_unknown_struct27),
    0x02C43C41: ("dark_samus_properties", _decode_dark_samus_properties),
