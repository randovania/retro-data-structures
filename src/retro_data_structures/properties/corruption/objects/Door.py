...
class Door(BaseObjectType):
    ...
    unknown_0xee808240: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0xEE808240, original_name="Unknown"),
        },
    )
    ...
    unknown_0x1b46b39b: bool = dataclasses.field(
        default=True,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x1B46B39B, original_name="Unknown"),
        },
    )
    unknown_0x7ab4846d: bool = dataclasses.field(
        default=True,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x7AB4846D, original_name="Unknown"),
        },
    )
    ...
    is_shield_down: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x321FAE5B, original_name="IsShieldDown"),
        },
    )
    is_invulnerable: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x9852C4B5, original_name="IsInvulnerable"),
        },
    )
    ...
    locked_scannable: ScannableParameters = dataclasses.field(
        default_factory=ScannableParameters,
        metadata={
            "reflection": FieldReflection[ScannableParameters](
                ScannableParameters,
                id=0x7177AFCC,
                original_name="LockedScannable",
                from_json=ScannableParameters.from_json,
                to_json=ScannableParameters.to_json,
            ),
        },
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_0xee808240 = structs.BIG_bool_.unpack(data.read(1))[0]
        ...
        unknown_0x1b46b39b = structs.BIG_bool_.unpack(data.read(1))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x7AB4846D
        unknown_0x7ab4846d = structs.BIG_bool_.unpack(data.read(1))[0]
        ...
        shell_model = structs.BIG_Q.unpack(data.read(8))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0xAE5B2114
        blue_shell_model = structs.BIG_Q.unpack(data.read(8))[0]
        ...
        burn_texture = structs.BIG_Q.unpack(data.read(8))[0]
        ...
        is_shield_down = structs.BIG_bool_.unpack(data.read(1))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x9852C4B5
        is_invulnerable = structs.BIG_bool_.unpack(data.read(1))[0]
        ...
        locked_scannable = ScannableParameters.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_bool_.pack(self.unknown_0xee808240))
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0x1b46b39b))

        data.write(b"z\xb4\x84m")  # 0x7ab4846d
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0x7ab4846d))
        ...
        data.write(structs.BIG_Q.pack(self.shell_model))

        data.write(b"\xae[!\x14")  # 0xae5b2114
        data.write(b"\x00\x08")  # size
        data.write(structs.BIG_Q.pack(self.blue_shell_model))
        ...
        data.write(b"\x00\x08")  # size
        data.write(structs.BIG_Q.pack(self.burn_texture))
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.is_shield_down))

        data.write(b"\x98R\xc4\xb5")  # 0x9852c4b5
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.is_invulnerable))
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.locked_scannable.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
...
def _decode_locked_scannable(data: typing.BinaryIO, game: Game, property_size: int) -> ScannableParameters:
    return ScannableParameters.from_stream(data, game, property_size)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xEE808240: ("unknown_0xee808240", structs.decode_BIG_bool_),
    0xCF90D15E: ("health", _decode_health),
    0x7B71AE90: ("vulnerability", _decode_vulnerability),
    0x1B46B39B: ("unknown_0x1b46b39b", structs.decode_BIG_bool_),
    0x7AB4846D: ("unknown_0x7ab4846d", structs.decode_BIG_bool_),
    0x4044D9E5: ("animation_information", _decode_animation_information),
    0xB20CC271: ("shell_model", structs.decode_BIG_Q),
    0xAE5B2114: ("blue_shell_model", structs.decode_BIG_Q),
    0x47B4E863: ("shell_color", _decode_shell_color),
    0x2589C3F0: ("burn_texture", structs.decode_BIG_Q),
    ...
    0x321FAE5B: ("is_shield_down", structs.decode_BIG_bool_),
    0x9852C4B5: ("is_invulnerable", structs.decode_BIG_bool_),
