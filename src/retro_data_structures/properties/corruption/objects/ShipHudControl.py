...
class ShipHudControl(BaseObjectType):
    ...
    unknown_struct63: UnknownStruct63 = dataclasses.field(
        default_factory=UnknownStruct63,
        metadata={
            "reflection": FieldReflection[UnknownStruct63](
                UnknownStruct63,
                id=0xE7F92ABC,
                original_name="UnknownStruct63",
                from_json=UnknownStruct63.from_json,
                to_json=UnknownStruct63.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_struct63 = UnknownStruct63.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.unknown_struct63.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
...
def _decode_unknown_struct63(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct63:
    return UnknownStruct63.from_stream(data, game, property_size)
