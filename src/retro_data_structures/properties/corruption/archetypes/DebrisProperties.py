...
from retro_data_structures.properties.corruption.archetypes.DebrisPropertiesOrientationEnum import (
...
class DebrisProperties(BaseProperty):
    ...
    unknown_0xd79690b4: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0xD79690B4, original_name="Unknown"),
        },
    )
    unknown_0x0145d02d: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x0145D02D, original_name="Unknown"),
        },
    )
    ...
    model_pivot_point: Vector = dataclasses.field(
        default_factory=lambda: Vector(x=0.0, y=0.0, z=0.0),
        metadata={
            "reflection": FieldReflection[Vector](
                Vector,
                id=0xEEDBB07E,
                original_name="ModelPivotPoint",
                from_json=Vector.from_json,
                to_json=Vector.to_json,
            ),
        },
    ...
    particle_system1_orientation: DebrisPropertiesOrientationEnum = dataclasses.field(
        default_factory=DebrisPropertiesOrientationEnum,
        metadata={
            "reflection": FieldReflection[DebrisPropertiesOrientationEnum](
                DebrisPropertiesOrientationEnum,
                id=0xF5DD4690,
                original_name="ParticleSystem1Orientation",
                from_json=DebrisPropertiesOrientationEnum.from_json,
                to_json=DebrisPropertiesOrientationEnum.to_json,
            ),
        },
    )
    ...
    particle_system2_orientation: DebrisPropertiesOrientationEnum = dataclasses.field(
        default_factory=DebrisPropertiesOrientationEnum,
        metadata={
            "reflection": FieldReflection[DebrisPropertiesOrientationEnum](
                DebrisPropertiesOrientationEnum,
                id=0x3CE95D9D,
                original_name="ParticleSystem2Orientation",
                from_json=DebrisPropertiesOrientationEnum.from_json,
                to_json=DebrisPropertiesOrientationEnum.to_json,
            ),
        },
    ...
    unknown_0xe73b9eb0: bool = dataclasses.field(
        default=True,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0xE73B9EB0, original_name="Unknown"),
        },
    )
    ...
    unknown_0x0e8a3f95: Vector = dataclasses.field(
        default_factory=lambda: Vector(x=1.0, y=1.0, z=1.0),
        metadata={
            "reflection": FieldReflection[Vector](
    ...
    unknown_0xf83c1c1f: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0xF83C1C1F, original_name="Unknown"),
        },
    )
    unknown_0x88b1af46: bool = dataclasses.field(
        default=True,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x88B1AF46, original_name="Unknown"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_0xd79690b4 = structs.BIG_bool_.unpack(data.read(1))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x0145D02D
        unknown_0x0145d02d = structs.BIG_bool_.unpack(data.read(1))[0]
        ...
        model_pivot_point = Vector.from_stream(data, game, property_size)
        ...
        particle_system1_orientation = DebrisPropertiesOrientationEnum.from_stream(data, game, property_size)
        ...
        particle_system2_orientation = DebrisPropertiesOrientationEnum.from_stream(data, game, property_size)
        ...
        unknown_0xe73b9eb0 = structs.BIG_bool_.unpack(data.read(1))[0]
        ...
        unknown_0x0e8a3f95 = Vector.from_stream(data, game, property_size)
        ...
        unknown_0xf83c1c1f = structs.BIG_bool_.unpack(data.read(1))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x88B1AF46
        unknown_0x88b1af46 = structs.BIG_bool_.unpack(data.read(1))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0xd79690b4))

        data.write(b"\x01E\xd0-")  # 0x145d02d
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0x0145d02d))
        ...
        data.write(b"\x00\x0c")  # size
        self.model_pivot_point.to_stream(data, game)
        ...
        self.particle_system1_orientation.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.particle_system2_orientation.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0xe73b9eb0))
        ...
        data.write(b"\x00\x0c")  # size
        self.unknown_0x0e8a3f95.to_stream(data, game)
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0xf83c1c1f))

        data.write(b"\x88\xb1\xafF")  # 0x88b1af46
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0x88b1af46))
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            particle_system1_orientation=DebrisPropertiesOrientationEnum.from_json(
                json_data["particle_system1_orientation"]
            ),
            ...
            particle_system2_orientation=DebrisPropertiesOrientationEnum.from_json(
                json_data["particle_system2_orientation"]
            ),
...
def _decode_model_pivot_point(data: typing.BinaryIO, game: Game, property_size: int) -> Vector:
    return Vector.from_stream(data, game, property_size)
...
def _decode_particle_system1_orientation(
    data: typing.BinaryIO, game: Game, property_size: int
) -> DebrisPropertiesOrientationEnum:
    return DebrisPropertiesOrientationEnum.from_stream(data, game, property_size)
...
def _decode_particle_system2_orientation(
    data: typing.BinaryIO, game: Game, property_size: int
) -> DebrisPropertiesOrientationEnum:
    return DebrisPropertiesOrientationEnum.from_stream(data, game, property_size)


def _decode_unknown_0x0e8a3f95(data: typing.BinaryIO, game: Game, property_size: int) -> Vector:
    return Vector.from_stream(data, game, property_size)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xD79690B4: ("unknown_0xd79690b4", structs.decode_BIG_bool_),
    0x0145D02D: ("unknown_0x0145d02d", structs.decode_BIG_bool_),
    ...
    0xE73B9EB0: ("unknown_0xe73b9eb0", structs.decode_BIG_bool_),
    0x8C73CB7C: ("is_shootable", structs.decode_BIG_bool_),
    0x0E8A3F95: ("unknown_0x0e8a3f95", _decode_unknown_0x0e8a3f95),
    ...
    0xF83C1C1F: ("unknown_0xf83c1c1f", structs.decode_BIG_bool_),
    0x88B1AF46: ("unknown_0x88b1af46", structs.decode_BIG_bool_),
}
