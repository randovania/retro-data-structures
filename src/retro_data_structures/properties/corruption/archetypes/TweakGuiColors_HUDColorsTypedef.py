...
class TweakGuiColors_HUDColorsTypedef(BaseProperty):
    ...
    unknown_0x57d7ba36: Color = dataclasses.field(
        default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0),
        metadata={
            "reflection": FieldReflection[Color](
    ...
    unknown_0x20b20348: Color = dataclasses.field(
        default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0),
        metadata={
            "reflection": FieldReflection[Color](
    ...
    unknown_0x8b45a902: Color = dataclasses.field(
        default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0),
        metadata={
            "reflection": FieldReflection[Color](
    ...
    unknown_0x9e1a78ff: Color = dataclasses.field(
        default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0),
        metadata={
            "reflection": FieldReflection[Color](
    ...
    unknown_0x8626bab3: Color = dataclasses.field(
        default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0),
        metadata={
            "reflection": FieldReflection[Color](
    ...
    unknown_0x4c158fc5: Color = dataclasses.field(
        default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0),
        metadata={
            "reflection": FieldReflection[Color](
    ...
    unknown_0x594a5e38: Color = dataclasses.field(
        default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0),
        metadata={
            "reflection": FieldReflection[Color](
    ...
    unknown_0x01a8c9c8: Color = dataclasses.field(
        default_factory=lambda: Color(r=0.0, g=0.0, b=0.0, a=0.0),
        metadata={
            "reflection": FieldReflection[Color](
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        if _FAST_FORMAT is None:
            _FAST_FORMAT = struct.Struct(
                ">LHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffffLHffff"
            )
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x10")  # size
        self.unknown_0x57d7ba36.to_stream(data, game)

        data.write(b" \xb2\x03H")  # 0x20b20348
        data.write(b"\x00\x10")  # size
        self.unknown_0x20b20348.to_stream(data, game)
        ...
        data.write(b"\x00\x10")  # size
        self.unknown_0x8b45a902.to_stream(data, game)

        data.write(b"\x9e\x1ax\xff")  # 0x9e1a78ff
        data.write(b"\x00\x10")  # size
        self.unknown_0x9e1a78ff.to_stream(data, game)

        data.write(b"\x86&\xba\xb3")  # 0x8626bab3
        data.write(b"\x00\x10")  # size
        self.unknown_0x8626bab3.to_stream(data, game)

        data.write(b"L\x15\x8f\xc5")  # 0x4c158fc5
        data.write(b"\x00\x10")  # size
        self.unknown_0x4c158fc5.to_stream(data, game)

        data.write(b"YJ^8")  # 0x594a5e38
        data.write(b"\x00\x10")  # size
        self.unknown_0x594a5e38.to_stream(data, game)

        data.write(b"\x01\xa8\xc9\xc8")  # 0x1a8c9c8
        data.write(b"\x00\x10")  # size
        self.unknown_0x01a8c9c8.to_stream(data, game)
...
def _decode_unknown_0x57d7ba36(data: typing.BinaryIO, game: Game, property_size: int) -> Color:
    return Color.from_stream(data, game, property_size)


def _decode_unknown_0x20b20348(data: typing.BinaryIO, game: Game, property_size: int) -> Color:
    return Color.from_stream(data, game, property_size)
...
def _decode_unknown_0x8b45a902(data: typing.BinaryIO, game: Game, property_size: int) -> Color:
    return Color.from_stream(data, game, property_size)


def _decode_unknown_0x9e1a78ff(data: typing.BinaryIO, game: Game, property_size: int) -> Color:
    return Color.from_stream(data, game, property_size)


def _decode_unknown_0x8626bab3(data: typing.BinaryIO, game: Game, property_size: int) -> Color:
    return Color.from_stream(data, game, property_size)


def _decode_unknown_0x4c158fc5(data: typing.BinaryIO, game: Game, property_size: int) -> Color:
    return Color.from_stream(data, game, property_size)


def _decode_unknown_0x594a5e38(data: typing.BinaryIO, game: Game, property_size: int) -> Color:
    return Color.from_stream(data, game, property_size)


def _decode_unknown_0x01a8c9c8(data: typing.BinaryIO, game: Game, property_size: int) -> Color:
    return Color.from_stream(data, game, property_size)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x01A8C9C8: ("unknown_0x01a8c9c8", _decode_unknown_0x01a8c9c8),
}
