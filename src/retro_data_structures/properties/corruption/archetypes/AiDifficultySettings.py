...
class AiDifficultySettings(BaseProperty):
    difficulty: enums.BerserkerEnumEnum = dataclasses.field(
        default=enums.BerserkerEnumEnum.Unknown4,
        metadata={
            "reflection": FieldReflection[enums.BerserkerEnumEnum](
                enums.BerserkerEnumEnum,
                id=0x2B082C6D,
                original_name="Difficulty",
                from_json=enums.BerserkerEnumEnum.from_json,
                to_json=enums.BerserkerEnumEnum.to_json,
            ),
        },
    )
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        self.difficulty.to_stream(data, game)
...
def _decode_difficulty(data: typing.BinaryIO, game: Game, property_size: int) -> enums.BerserkerEnumEnum:
    return enums.BerserkerEnumEnum.from_stream(data, game)
