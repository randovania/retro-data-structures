...
class TweakPlayer_SuitDamageReduction(BaseProperty):
    hazard: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x580F155F, original_name="Hazard"),
        },
    )
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_f.pack(self.hazard))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    0x580F155F: ("hazard", structs.decode_BIG_f),
}
