...
if typing.TYPE_CHECKING:
    ...
    class TweakBall_ScrewAttackJson(typing_extensions.TypedDict):
        ...
        unknown_0x315df4d7: float
        screw_attack_wall_jump_vertical_velocity: float
        unknown_0xc5b758f5: float
...
class TweakBall_ScrewAttack(BaseProperty):
    ...
    unknown_0x315df4d7: float = dataclasses.field(
        default=30.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x315DF4D7, original_name="Unknown"),
        },
    )
    ...
    unknown_0xc5b758f5: float = dataclasses.field(
        default=30.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0xC5B758F5, original_name="Unknown"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_0x315df4d7 = structs.BIG_f.unpack(data.read(4))[0]
        ...
        unknown_0xc5b758f5 = structs.BIG_f.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0x315df4d7))
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0xc5b758f5))
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_0x315df4d7=json_data["unknown_0x315df4d7"],
            screw_attack_wall_jump_vertical_velocity=json_data["screw_attack_wall_jump_vertical_velocity"],
            unknown_0xc5b758f5=json_data["unknown_0xc5b758f5"],
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x315DF4D7: ("unknown_0x315df4d7", structs.decode_BIG_f),
    0x5DEC33C5: ("screw_attack_wall_jump_vertical_velocity", structs.decode_BIG_f),
    0xC5B758F5: ("unknown_0xc5b758f5", structs.decode_BIG_f),
