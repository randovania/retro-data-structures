...
class TweakPlayerRes_MapScreenIcons(BaseProperty):
    ...
    unknown_0x450997d8: str = dataclasses.field(
        default="",
        metadata={
            "reflection": FieldReflection[str](str, id=0x450997D8, original_name="Unknown"),
        },
    )
    unknown_0x079a913b: str = dataclasses.field(
        default="",
        metadata={
            "reflection": FieldReflection[str](str, id=0x079A913B, original_name="Unknown"),
        },
    )
    unknown_0x7e55a798: str = dataclasses.field(
        default="",
        metadata={
            "reflection": FieldReflection[str](str, id=0x7E55A798, original_name="Unknown"),
        },
    )
    unknown_0x358a191b: str = dataclasses.field(
        default="",
        metadata={
            "reflection": FieldReflection[str](str, id=0x358A191B, original_name="Unknown"),
        },
    )
...
def _decode_unknown_0x450997d8(data: typing.BinaryIO, game: Game, property_size: int) -> str:
    return data.read(property_size)[:-1].decode("utf-8")


def _decode_unknown_0x079a913b(data: typing.BinaryIO, game: Game, property_size: int) -> str:
    return data.read(property_size)[:-1].decode("utf-8")


def _decode_unknown_0x7e55a798(data: typing.BinaryIO, game: Game, property_size: int) -> str:
    return data.read(property_size)[:-1].decode("utf-8")


def _decode_unknown_0x358a191b(data: typing.BinaryIO, game: Game, property_size: int) -> str:
    return data.read(property_size)[:-1].decode("utf-8")
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x079A913B: ("unknown_0x079a913b", _decode_unknown_0x079a913b),
