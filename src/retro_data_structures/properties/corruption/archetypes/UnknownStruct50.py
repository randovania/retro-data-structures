...
class UnknownStruct50(BaseProperty):
    ...
    electric_damage_info: DamageInfo = dataclasses.field(
        default_factory=DamageInfo,
        metadata={
            "reflection": FieldReflection[DamageInfo](
                DamageInfo,
                id=0xF808C9EE,
                original_name="ElectricDamageInfo",
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        electric_damage_info = DamageInfo.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        self.electric_damage_info.to_stream(data, game)
        after = data.tell()
        data.seek(before)
...
def _decode_electric_damage_info(data: typing.BinaryIO, game: Game, property_size: int) -> DamageInfo:
