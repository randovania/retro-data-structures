...
if typing.TYPE_CHECKING:
    ...
    class TweakPlayer_MiscJson(typing_extensions.TypedDict):
        ...
        unknown_0xfb909bc3: float
        left_analog_max: float
        right_analog_max: float
        unknown_0x88297760: bool
...
class TweakPlayer_Misc(BaseProperty):
    ...
    unknown_0xfb909bc3: float = dataclasses.field(
        default=5.0,
        metadata={
    ...
    unknown_0x88297760: bool = dataclasses.field(
        default=True,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x88297760, original_name="Unknown"),
        },
    )
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0xfb909bc3))
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.unknown_0x88297760))
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_0xfb909bc3=json_data["unknown_0xfb909bc3"],
            left_analog_max=json_data["left_analog_max"],
            right_analog_max=json_data["right_analog_max"],
            unknown_0x88297760=json_data["unknown_0x88297760"],
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xFB909BC3: ("unknown_0xfb909bc3", structs.decode_BIG_f),
    0xF1F038DE: ("left_analog_max", structs.decode_BIG_f),
    0x2B1F5094: ("right_analog_max", structs.decode_BIG_f),
    0x88297760: ("unknown_0x88297760", structs.decode_BIG_bool_),
}
