...
class TeamAIDebugEnum(BaseProperty):
    team_ai_state: TeamAIState = dataclasses.field(
        default=TeamAIState.Unknown1,
        metadata={
            "reflection": FieldReflection[TeamAIState](
                TeamAIState,
                id=0x94D97B5A,
                original_name="TeamAIState",
                from_json=TeamAIState.from_json,
                to_json=TeamAIState.to_json,
            ),
        },
    )
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        self.team_ai_state.to_stream(data, game)
...
def _decode_team_ai_state(data: typing.BinaryIO, game: Game, property_size: int) -> TeamAIState:
    return TeamAIState.from_stream(data, game)
