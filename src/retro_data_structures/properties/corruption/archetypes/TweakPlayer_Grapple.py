...
class TweakPlayer_Grapple(BaseProperty):
    ...
    unknown_0x755f0513: float = dataclasses.field(
        default=10.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x755F0513, original_name="Unknown"),
        },
    )
    unknown_0x15cf139d: float = dataclasses.field(
        default=10.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x15CF139D, original_name="Unknown"),
        },
    )
    unknown_0x2d255c98: float = dataclasses.field(
        default=10.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x2D255C98, original_name="Unknown"),
        },
    )
    unknown_0x4db54a16: float = dataclasses.field(
        default=10.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x4DB54A16, original_name="Unknown"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_0x755f0513 = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x15CF139D
        unknown_0x15cf139d = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x2D255C98
        unknown_0x2d255c98 = structs.BIG_f.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0x4DB54A16
        unknown_0x4db54a16 = structs.BIG_f.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0x755f0513))

        data.write(b"\x15\xcf\x13\x9d")  # 0x15cf139d
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0x15cf139d))

        data.write(b"-%\\\x98")  # 0x2d255c98
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0x2d255c98))

        data.write(b"M\xb5J\x16")  # 0x4db54a16
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.unknown_0x4db54a16))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x755F0513: ("unknown_0x755f0513", structs.decode_BIG_f),
    0x15CF139D: ("unknown_0x15cf139d", structs.decode_BIG_f),
    0x2D255C98: ("unknown_0x2d255c98", structs.decode_BIG_f),
    0x4DB54A16: ("unknown_0x4db54a16", structs.decode_BIG_f),
}
