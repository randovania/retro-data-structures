...
class NewCameraShakerStruct(BaseProperty):
    ...
    unknown_3: int = dataclasses.field(
        default=0,
        metadata={
            "reflection": FieldReflection[int](int, id=0x00000002, original_name="Unknown 3"),
        },
    )
    ...
    unknown_9: int = dataclasses.field(
        default=0,
        metadata={
            "reflection": FieldReflection[int](int, id=0x00000008, original_name="Unknown 9"),
        },
    )
    unknown_10: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x00000009, original_name="Unknown 10"),
        },
    )
    ...
    def from_stream(
        ...
        unknown_10 = structs.BIG_bool_.unpack(data.read(1))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_bool_.pack(self.unknown_10))
