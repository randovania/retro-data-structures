...
if typing.TYPE_CHECKING:
    ...
    class RidleyStruct2Json(typing_extensions.TypedDict):
        unknown_1: int
        unknown_2: float
        unknown_3: float
        unknown_4: float
...
class RidleyStruct2(BaseProperty):
    ...
    unknown_9: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x00000008, original_name="Unknown 9"),
        },
    )
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("RidleyStruct2Json", data)
        return cls(
