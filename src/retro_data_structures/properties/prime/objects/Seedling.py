...
class Seedling(BaseObjectType):
    ...
    unknown_1: AssetId = dataclasses.field(
        ...
        metadata={
            "asset_types": ["CMDL"],
            "reflection": FieldReflection[AssetId](AssetId, id=0x00000006, original_name="Unknown 1"),
        },
    )
    unknown_2: AssetId = dataclasses.field(
        default=default_asset_id,
        metadata={
            "asset_types": ["WPSC"],
            "reflection": FieldReflection[AssetId](AssetId, id=0x00000007, original_name="Unknown 2"),
        },
    )
    ...
    def _dependencies_for_unknown_2(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return asset_manager.get_dependencies_for_asset(self.unknown_2)
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            try:
                ...
                raise Exception(f"Error finding dependencies for Seedling.{field_name} ({field_type}): {e}")
