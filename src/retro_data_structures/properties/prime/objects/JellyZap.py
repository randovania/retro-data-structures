...
class JellyZap(BaseObjectType):
    ...
    attack_radius: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x00000007, original_name="AttackRadius"),
        },
    )
    ...
    priority: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x0000000F, original_name="Priority"),
        },
    )
    repulse_radius: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x00000010, original_name="RepulseRadius"),
        },
    )
    attract_radius: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x00000011, original_name="AttractRadius"),
        },
    )
    unknown_8: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x00000012, original_name="Unknown 8"),
        },
    )
    unknown_9: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x00000013, original_name="Unknown 9"),
        },
    )
    ...
    def from_stream(
        ...
        repulse_radius = structs.BIG_f.unpack(data.read(4))[0]
        attract_radius = structs.BIG_f.unpack(data.read(4))[0]
        unknown_8 = structs.BIG_f.unpack(data.read(4))[0]
        unknown_9 = structs.BIG_bool_.unpack(data.read(1))[0]
        return cls(
            name,
            position,
            rotation,
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_f.pack(self.repulse_radius))
        data.write(structs.BIG_f.pack(self.attract_radius))
        data.write(structs.BIG_f.pack(self.unknown_8))
        data.write(structs.BIG_bool_.pack(self.unknown_9))
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            repulse_radius=json_data["repulse_radius"],
            attract_radius=json_data["attract_radius"],
    ...
    def to_json(self) -> json_util.JsonObject:
        return {
            ...
            "repulse_radius": self.repulse_radius,
            "attract_radius": self.attract_radius,
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            try:
                ...
                raise Exception(f"Error finding dependencies for JellyZap.{field_name} ({field_type}): {e}")
