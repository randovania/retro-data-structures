...
if typing.TYPE_CHECKING:
    ...
    class FireFleaJson(typing_extensions.TypedDict):
        name: str
...
class FireFlea(BaseObjectType):
    ...
    def from_stream(
        ...
        return cls(
            name, position, rotation, scale, unnamed_0x00000004, unnamed_0x00000005, unknown_1, unknown_2, unknown_3
        )
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("FireFleaJson", data)
        return cls(
            name=json_data["name"],
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            try:
                ...
                raise Exception(f"Error finding dependencies for FireFlea.{field_name} ({field_type}): {e}")
