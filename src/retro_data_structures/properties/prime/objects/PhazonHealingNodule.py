...
class PhazonHealingNodule(BaseObjectType):
    ...
    unused: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0x00000006, original_name="Unused"),
        },
    )
    elsc: AssetId = dataclasses.field(
        ...
        metadata={
            "asset_types": ["ELSC"],
            "reflection": FieldReflection[AssetId](AssetId, id=0x00000007, original_name="ELSC"),
        },
    )
    target_locator: str = dataclasses.field(
        default="",
        metadata={
            "reflection": FieldReflection[str](str, id=0x00000008, original_name="Target Locator"),
        },
    )
    ...
    def from_stream(
        ...
        return cls(
            name, position, rotation, scale, unnamed_0x00000004, unnamed_0x00000005, unused, elsc, target_locator
        )
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            try:
                ...
                raise Exception(f"Error finding dependencies for PhazonHealingNodule.{field_name} ({field_type}): {e}")
