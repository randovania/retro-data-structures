...
if typing.TYPE_CHECKING:
    ...
    class FlaahgraTentacleJson(typing_extensions.TypedDict):
        name: str
...
class FlaahgraTentacle(BaseObjectType):
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("FlaahgraTentacleJson", data)
        return cls(
            name=json_data["name"],
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            try:
                ...
                raise Exception(f"Error finding dependencies for FlaahgraTentacle.{field_name} ({field_type}): {e}")
