...
class CameraWaypoint(BaseObjectType):
    ...
    field_of_view: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x00000004, original_name="Field Of View"),
        },
    )
    unknown: int = dataclasses.field(
        default=0,
        metadata={
            "reflection": FieldReflection[int](int, id=0x00000005, original_name="Unknown"),
        },
    )
    ...
    def from_stream(
        ...
        return cls(name, position, rotation, active, field_of_view, unknown)
