...
if typing.TYPE_CHECKING:
    ...
    class EmperorIngStage3StructAJson(typing_extensions.TypedDict):
...
class EmperorIngStage3StructA(BaseProperty):
    ...
    beam_sound: int = dataclasses.field(
        default=0,
        metadata={
            "sound": True,
            "reflection": FieldReflection[int](int, id=0xF6F185D6, original_name="BeamSound"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        beam_sound = structs.BIG_l.unpack(data.read(4))[0]

        return cls(beam_info, damage, beam_sound)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_l.pack(self.beam_sound))

    @classmethod
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("EmperorIngStage3StructAJson", data)
        return cls(
    ...
    def _dependencies_for_beam_sound(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return asset_manager.get_audio_group_dependency(self.beam_sound)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xF6F185D6: ("beam_sound", structs.decode_BIG_l),
}
