...
class EmperorIngStage2TentacleData(BaseProperty):
    detection_time: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0xBAA9254A, original_name="DetectionTime"),
        },
    )
    forget_time: float = dataclasses.field(
        default=0.0,
        metadata={
            "reflection": FieldReflection[float](float, id=0x1FE28A36, original_name="ForgetTime"),
        },
    )
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_f.pack(self.detection_time))

        data.write(b"\x1f\xe2\x8a6")  # 0x1fe28a36
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_f.pack(self.forget_time))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    0xBAA9254A: ("detection_time", structs.decode_BIG_f),
    0x1FE28A36: ("forget_time", structs.decode_BIG_f),
}
