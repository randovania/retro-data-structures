...
class MysteryFlyerData(BaseProperty):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        shot_projectile = structs.BIG_L.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_L.pack(self.shot_projectile))

        data.write(b"\xce\xa3\x018")  # 0xcea30138
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.shot_damage.to_stream(data, game, default_override={"di_weapon_type": 11, "di_damage": 5.0})
        after = data.tell()
        data.seek(before)
    ...
    def _dependencies_for_shot_projectile(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return asset_manager.get_dependencies_for_asset(self.shot_projectile)

    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return self._dependencies_for_shot_projectile(asset_manager)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    0x51253BA3: ("shot_projectile", structs.decode_BIG_L),
