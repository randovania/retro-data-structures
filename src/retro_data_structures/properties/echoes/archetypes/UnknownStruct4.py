...
class UnknownStruct4(BaseProperty):
    behaviour_type: int = dataclasses.field(
        default=0,
        metadata={
            "reflection": FieldReflection[int](int, id=0xC1E747AD, original_name="BehaviourType"),
        },
    )
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_l.pack(self.behaviour_type))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    0xC1E747AD: ("behaviour_type", structs.decode_BIG_l),
}
