...
class FlagsPlayerHint(enum.IntFlag):
    Unknown1 = 1
    ControlDirOverride = 2
    ExtendTargetDistance = 4
    OutOfBallLookAtHint = 8
    SpiderBallControlXY = 16
    DisableUnmorph = 32
    DisableMorph = 64
    DisableControls = 128
    DisableBoost = 256
    ForceCombatVisor = 512
    ForceScanVisor = 1024
    ForceDarkVisor = 2048
    ForceEchoVisor = 4096
    FreezePlayer = 8192
    ...
    Unknown18 = 131072
    Unknown19 = 262144
    ForceFreeLook = 524288
    Unknown21 = 1048576
    ForceFirstPerson = 2097152
    ForceThirdPerson = 4194304
    Unknown24 = 8388608
...
class PlayerHint(BaseObjectType):
    ...
    flags_player_hint: FlagsPlayerHint = dataclasses.field(
        default=FlagsPlayerHint(1),
        metadata={
            "reflection": FieldReflection[FlagsPlayerHint](
                FlagsPlayerHint,
                id=0x1BCE57E1,
                original_name="FlagsPlayerHint",
                from_json=FlagsPlayerHint.from_json,
                to_json=FlagsPlayerHint.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        flags_player_hint = FlagsPlayerHint.from_stream(data, game)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        self.flags_player_hint.to_stream(data, game)
...
def _decode_flags_player_hint(data: typing.BinaryIO, game: Game, property_size: int) -> FlagsPlayerHint:
    return FlagsPlayerHint.from_stream(data, game)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xC91EF813: ("unknown", structs.decode_BIG_f),
