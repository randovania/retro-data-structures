...
class VisorGoo(BaseObjectType):
    ...
    sound_hit_sound: int = dataclasses.field(
        default=-1,
        metadata={
            "reflection": FieldReflection[int](int, id=0xA6DC9A92, original_name="Sound_HitSound"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        sound_hit_sound = structs.BIG_l.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_l.pack(self.sound_hit_sound))
    ...
    def _dependencies_for_electric(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return asset_manager.get_dependencies_for_asset(self.electric)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x71DBE2F2: ("electric", structs.decode_BIG_L),
    ...
    0xA6DC9A92: ("sound_hit_sound", structs.decode_BIG_l),
