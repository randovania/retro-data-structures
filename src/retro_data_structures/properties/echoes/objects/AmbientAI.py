...
class AmbientAI(BaseObjectType):
    ...
    unknown_0xbfe017de: int = dataclasses.field(
        default=-1,
        metadata={
            "reflection": FieldReflection[int](int, id=0xBFE017DE, original_name="Unknown"),
        },
    )
    unknown_0xed5f16ac: int = dataclasses.field(
        default=-1,
        metadata={
            "reflection": FieldReflection[int](int, id=0xED5F16AC, original_name="Unknown"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        unknown_0xbfe017de = structs.BIG_l.unpack(data.read(4))[0]

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0xED5F16AC
        unknown_0xed5f16ac = structs.BIG_l.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_l.pack(self.unknown_0xbfe017de))

        data.write(b"\xed_\x16\xac")  # 0xed5f16ac
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_l.pack(self.unknown_0xed5f16ac))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xBFE017DE: ("unknown_0xbfe017de", structs.decode_BIG_l),
    0xED5F16AC: ("unknown_0xed5f16ac", structs.decode_BIG_l),
}
