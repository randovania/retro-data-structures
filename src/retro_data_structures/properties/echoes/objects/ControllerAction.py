...
if typing.TYPE_CHECKING:
    ...
    class ControllerActionJson(typing_extensions.TypedDict):
        ...
        controller_action_struct: json_util.JsonObject
        one_shot: bool
...
class ControllerAction(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        controller_action_struct = ControllerActionStruct.from_stream(data, game, property_size)

        property_id, property_size = structs.BIG_LH.unpack(data.read(6))
        assert property_id == 0xEAD7B7BB
        one_shot = structs.BIG_bool_.unpack(data.read(1))[0]

        return cls(editor_properties, controller_action_struct, one_shot)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.controller_action_struct.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            controller_action_struct=ControllerActionStruct.from_json(json_data["controller_action_struct"]),
...
def _decode_controller_action_struct(data: typing.BinaryIO, game: Game, property_size: int) -> ControllerActionStruct:
    return ControllerActionStruct.from_stream(data, game, property_size)
