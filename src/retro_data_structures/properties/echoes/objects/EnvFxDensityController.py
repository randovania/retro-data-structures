...
class EnvFxDensityController(BaseObjectType):
    ...
    fade_speed: int = dataclasses.field(
        default=500,
        metadata={
            "reflection": FieldReflection[int](int, id=0x65A823B4, original_name="FadeSpeed"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        fade_speed = structs.BIG_l.unpack(data.read(4))[0]

        return cls(editor_properties, density, fade_speed)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x04")  # size
        data.write(structs.BIG_l.pack(self.fade_speed))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x65A823B4: ("fade_speed", structs.decode_BIG_l),
}
