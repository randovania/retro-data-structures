...
if typing.TYPE_CHECKING:
    ...
    class CannonBallJson(typing_extensions.TypedDict):
...
class CannonBall(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, effect)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("CannonBallJson", data)
        return cls(
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return self._dependencies_for_effect(asset_manager)
