...
class SwampBossStage2(BaseObjectType):
    ...
    swamp_boss_stage2_data: SwampBossStage2Data = dataclasses.field(
        default_factory=SwampBossStage2Data,
        metadata={
            "reflection": FieldReflection[SwampBossStage2Data](
                SwampBossStage2Data,
                id=0xB31B771D,
                original_name="SwampBossStage2Data",
                from_json=SwampBossStage2Data.from_json,
                to_json=SwampBossStage2Data.to_json,
            ),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        swamp_boss_stage2_data = SwampBossStage2Data.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        before = data.tell()
        data.write(b"\x00\x00")  # size placeholder
        self.swamp_boss_stage2_data.to_stream(data, game)
        after = data.tell()
        data.seek(before)
        data.write(structs.BIG_H.pack(after - before - 2))
        data.seek(after)
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            try:
                ...
                raise Exception(f"Error finding dependencies for SwampBossStage2.{field_name} ({field_type}): {e}")
...
def _decode_swamp_boss_stage2_data(data: typing.BinaryIO, game: Game, property_size: int) -> SwampBossStage2Data:
    return SwampBossStage2Data.from_stream(data, game, property_size)
