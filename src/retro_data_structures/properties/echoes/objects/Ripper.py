...
class Ripper(BaseObjectType):
    ...
    grapple_info: GrappleParameters = dataclasses.field(
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        grapple_info = GrappleParameters.from_stream(data, game, property_size)
...
def _decode_grapple_info(data: typing.BinaryIO, game: Game, property_size: int) -> GrappleParameters:
    return GrappleParameters.from_stream(data, game, property_size)
