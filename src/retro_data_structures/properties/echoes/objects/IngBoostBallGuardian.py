...
if typing.TYPE_CHECKING:
    ...
    class IngBoostBallGuardianJson(typing_extensions.TypedDict):
...
class IngBoostBallGuardian(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, unknown_struct28, unknown_struct29)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("IngBoostBallGuardianJson", data)
        return cls(
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.unknown_struct28.dependencies_for, "unknown_struct28", "UnknownStruct28"),
            (self.unknown_struct29.dependencies_for, "unknown_struct29", "UnknownStruct29"),
        ]:
            try:
                yield from method(asset_manager)
            except Exception as e:
                raise Exception(f"Error finding dependencies for IngBoostBallGuardian.{field_name} ({field_type}): {e}")
