...
class PickupGenerator(BaseObjectType):
    ...
    rules: AssetId = dataclasses.field(
        default=default_asset_id,
        metadata={
            "asset_types": ["RULE"],
            "reflection": FieldReflection[AssetId](AssetId, id=0x0C5143FE, original_name="Rules"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        rules = structs.BIG_L.unpack(data.read(4))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_L.pack(self.rules))
    ...
    def _dependencies_for_rules(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return asset_manager.get_dependencies_for_asset(self.rules)

    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return self._dependencies_for_rules(asset_manager)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x0C5143FE: ("rules", structs.decode_BIG_L),
}
