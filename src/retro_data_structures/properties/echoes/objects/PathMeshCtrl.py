...
class PathMeshCtrl(BaseObjectType):
    ...
    initial_count: int = dataclasses.field(
        default=1,
        metadata={
            "reflection": FieldReflection[int](int, id=0x7A6E0DE9, original_name="InitialCount"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        type = structs.BIG_l.unpack(data.read(4))[0]
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x7A6E0DE9: ("initial_count", structs.decode_BIG_l),
}
