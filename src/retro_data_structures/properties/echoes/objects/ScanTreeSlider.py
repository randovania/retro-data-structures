...
if typing.TYPE_CHECKING:
    ...
    class ScanTreeSliderJson(typing_extensions.TypedDict):
...
class ScanTreeSlider(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, name_string_table, name_string_name, unknown)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("ScanTreeSliderJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x0261A4E0: ("unknown", structs.decode_BIG_l),
}
