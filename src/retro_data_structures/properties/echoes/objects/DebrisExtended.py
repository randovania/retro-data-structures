...
class DebrisExtended(BaseObjectType):
    ...
    movement_direction: Vector = dataclasses.field(
        default_factory=lambda: Vector(x=0.0, y=0.0, z=1.0),
        metadata={
            "reflection": FieldReflection[Vector](
                Vector,
                id=0x8075F8F8,
                original_name="MovementDirection",
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        movement_direction = Vector.from_stream(data, game, property_size)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        self.movement_direction.to_stream(data, game)
...
def _decode_movement_direction(data: typing.BinaryIO, game: Game, property_size: int) -> Vector:
