...
class MemoryRelay(BaseObjectType):
    ...
    delayed_action: bool = dataclasses.field(
        default=False,
        metadata={
            "reflection": FieldReflection[bool](bool, id=0xA905CCF0, original_name="DelayedAction"),
        },
    )
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        delayed_action = structs.BIG_bool_.unpack(data.read(1))[0]
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(b"\x00\x01")  # size
        data.write(structs.BIG_bool_.pack(self.delayed_action))
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0xA905CCF0: ("delayed_action", structs.decode_BIG_bool_),
}
