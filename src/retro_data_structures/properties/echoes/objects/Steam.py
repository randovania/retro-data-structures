...
class Steam(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        steam = structs.BIG_L.unpack(data.read(4))[0]
        ...
        return cls(editor_properties, trigger, steam, strength, fade_in_rate, fade_out_rate, radius, unknown)
    ...
    def to_stream(self, data: typing.BinaryIO, game: Game, default_override: dict | None = None) -> None:
        ...
        data.write(structs.BIG_L.pack(self.steam))
    ...
    def _dependencies_for_steam(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return asset_manager.get_dependencies_for_asset(self.steam)

    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        return self._dependencies_for_steam(asset_manager)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, Game, int], typing.Any]]] = {
    ...
    0x26346050: ("steam", structs.decode_BIG_L),
    ...
    0xA366C949: ("unknown", structs.decode_BIG_bool_),
}
