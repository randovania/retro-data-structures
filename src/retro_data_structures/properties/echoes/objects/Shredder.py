...
class Shredder(BaseObjectType):
    ...
    data: UnknownStruct39 = dataclasses.field(
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        data_ = UnknownStruct39.from_stream(data, game, property_size)
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            try:
                ...
                raise Exception(f"Error finding dependencies for Shredder.{field_name} ({field_type}): {e}")
...
def _decode_data(data: typing.BinaryIO, game: Game, property_size: int) -> UnknownStruct39:
