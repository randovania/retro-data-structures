...
class ScriptLayerController(BaseObjectType):
    ...
    layer: LayerSwitch = dataclasses.field(
    ...
    def _fast_decode(cls, data: typing.BinaryIO, game: Game, property_count: int) -> typing_extensions.Self | None:
        ...
        layer = LayerSwitch.from_stream(data, game, property_size)
...
def _decode_layer(data: typing.BinaryIO, game: Game, property_size: int) -> LayerSwitch:
    return LayerSwitch.from_stream(data, game, property_size)
